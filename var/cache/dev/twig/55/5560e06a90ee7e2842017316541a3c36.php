...
/* header.html.twig */
class __TwigTemplate_2a33e7516565e18474d6613aa3ae821e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <div class=\"header--element social\">
            <a href=\"";
        // line 8
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_social_media");
        echo "\">feeds</a>
        </div>
        <div class=\"header--element statistics\">
            <a href=\"";
        // line 11
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_social_media");
        echo "\">statistics</a>
...
";
    ...
    {
        return array (  84 => 11,  78 => 8,  72 => 5,  68 => 3,  58 => 2,  35 => 1,);
    }
...
{% block body %}
    <div class=\"header--section\">
        <div class=\"header--element content\">
            <a href=\"{{ path('app_social_media') }}\">new post</a>
        </div>
        <div class=\"header--element social\">
            <a href=\"{{ path('app_social_media') }}\">feeds</a>
        </div>
        <div class=\"header--element statistics\">
            <a href=\"{{ path('app_social_media') }}\">statistics</a>
        </div>

    </div>
{% endblock %}", "header.html.twig", "C:\\Users\\chadha\\social_share_hub\\templates\\header.html.twig");
    }
}
