...
class __TwigTemplate_45228c6bb5e2bdf61ec2a6f201ea99e4 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 7, $this->source); })()), "flashes", ["unauthorized_access"], "method", false, false, false, 7));
