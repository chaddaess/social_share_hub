 ...
 */
class getTwitterPictureRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\TwitterPictureRepository' shared autowired service.
     *
     * @return \App\Repository\TwitterPictureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4) . '' . \DIRECTORY_SEPARATOR . 'src' . \DIRECTORY_SEPARATOR . 'Repository' . \DIRECTORY_SEPARATOR . 'TwitterPictureRepository.php';

        return $container->privates['App\\Repository\\TwitterPictureRepository'] = new \App\Repository\TwitterPictureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
