 ...
 */
class getMyGoogleAuthenticatorService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Security\\MyGoogleAuthenticator'] = new \App\Security\MyGoogleAuthenticator(($container->services['knpu.oauth2.registry'] ?? ($container->services['knpu.oauth2.registry'] = new \KnpU\OAuth2ClientBundle\Client\ClientRegistry($container, ['google' => 'knpu.oauth2.client.google']))), $a, $b, $b);
    }
}
